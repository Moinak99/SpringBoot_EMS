...
<body>
 ...
 <br>
   ...
   <div class=""container>
   ...
   </div><form action="searchemployee" method="post">
       ...
       <a href="buttons.jsp">Cancel Searching</a>
   </form>
   </div>
   <br>
    <br>
                 ...
                 <td>${ stinfo.employee_cast}</td>
                  <td>${ stinfo.employee_phoneno}</td>
                   <td>${ stinfo.employee_deff}</td>
                    ...
                    <td><a href="/updateemployee?employee_id=${stinfo.employee_id}">Edit Information</a></td>
